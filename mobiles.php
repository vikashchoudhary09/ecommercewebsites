...
if($conn->connect_error){
  ...
  $sql = "select * from mobileslider"; 
    ...
    { 
     ...
     $sql2 = "select * from mobileproduct"; 
...
<div class="container-fluid">
	<div class="row">
		...
		?>
		<div class="col-md-12">
			<img src="photo/<?php echo $values['image'];?>" class="img-fluid" alt="...">
		</div>
		<?php
	}
	?>
...
<div class="container-fluid">
	<div class="row">
		...
		<div class="col-md-2 border">
			<center><br>
			<img src="photo/<?php echo $values2['image'];?>" class="card-img-top mobile" alt="...">
			<br><br>
		...
		<!-- <div class="col-md-2 border">
			<center><br>
			<img src="https://www.91-img.com/pictures/154880-v2-iqoo-12-pro-mobile-phone-medium-1.jpg?tr=q-80" class="card-img-top mobile" alt="...">
			<br><br>
			<b>iQOO 12 Pro</b>
			<p>$9999</p>
			<i class="fa-regular fa-star"></i>
