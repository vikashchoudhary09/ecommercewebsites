...
if($conn->connect_error){
  ...
  $sql = "select * from womanslider"; 
    ...
    { 
     ...
     $sql2 = "select * from womanproduct1"; 
    ...
    { 
      ...
      $sql3 = "select * from womanproduct2"; 
...
<div class="container-fluid">
	<div class="row">
		...
		<div class="col-md-2 border">
			<center>
			<img src="photo/<?php echo $values2['image'];?>" class="img-thumbnail" alt="...">
			<br><br>
		...
		<!-- <div class="col-md-2 border">
			<center>
			<img src="https://images.bestsellerclothing.in/data/only/oct-28-2022/231084901_g1.jpg?width=380&height=500&mode=fill&fill=blur&format=auto" class="img-thumbnail" alt="...">
			<br><br>
...
<div class="container-fluid big">
	<br><br>
	<center>
	<h2><b>The Best Woman Design</b> </h2>
</center>
	<br><br>
	<div class="row">
		<?php foreach ($row3 as $key => $values3) {
		?>
		<div class="col-md-3 border">
			<center>
			<img src="photo/<?php echo $values3['image'];?>" class="img-thumbnail" alt="...">
			<br><br>
			<b><?php  echo $values3['name'];?></b>
	...
	<!-- 	<div class="col-md-3 border">
			<center>
			<img src="https://images.bestsellerclothing.in/data/only/13-july-2023/155535601_g1.jpg?width=380&height=500&mode=fill&fill=blur&format=auto" class="img-thumbnail" alt="...">
			<br><br>
			<b>The Best men's Shadow Work </b>
			<p>$999</p>
			<button class="btn btn btn-outline-success">add to card</button>
