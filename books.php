...
<div class="container-fluid">
	<div class="row">
		...
		<div class="col-md-2 border">
			<center>
			<img src="photo/<?php echo $values2['image'];?>" class="img-thumbnail imm" alt="...">
			<br><br>
		...
		<!-- <div class="col-md-2 border">
			<center>
			<img src="https://bc-img.s3.ap-south-1.amazonaws.com/images/cover/761/9781784709082.jpg" class="img-thumbnail" alt="...">
			<br><br>
			<b>The Shadow Work </b>
			<p>$399</p>
			<button class="btn btn btn-outline-success">add to card</button>
